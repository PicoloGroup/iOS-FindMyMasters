...
class AuthViewController: UIViewController, DataSourceProviderDelegate {
  ...
  private func configureNavigationBar() {
    navigationItem.title = "Find My Masters"
    guard let navigationBar = navigationController?.navigationBar else { return }
    navigationBar.prefersLargeTitles = true
    navigationBar.titleTextAttributes = [.foregroundColor: UIColor.systemRed]
    navigationBar.largeTitleTextAttributes = [.foregroundColor: UIColor.systemRed]
  }
